...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser.setText("欢迎使用权限配置助手，请点击下方【更新数据】开始操作\n")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "图灵权限助手"))
        self.label_2.setText(_translate("MainWindow", "状态："))
        self.btn_discard.setText(_translate("MainWindow", "重置调整"))
        self.btn_exportAll.setText(_translate("MainWindow", "导出表格"))
        self.label.setText(_translate("MainWindow", "请在每个角色权限调整后单独保存！"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "请输入TOKEN："))
        self.btn_q_role.setText(_translate("MainWindow", "更新数据"))
        self.btn_send_email.setText(_translate("MainWindow", "发送邮件"))
        self.btn_preview.setText(_translate("MainWindow", "改动预览"))
        self.btn_save.setText(_translate("MainWindow", "保存调整"))
